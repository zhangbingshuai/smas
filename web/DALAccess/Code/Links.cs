...
namespace Tc.DAL
{
	...
	public partial class Links
	{
		...
		public int GetMaxId()
		{
		return DbHelper.GetMaxID("ID", "Links"); 
		}
		...
		public int Add(Tc.Model.Links model)
		{
			...
			strSql.Append("Name,Url,LogoUrl,IsDisplay,AddTime)");
		...
		public Tc.Model.Links GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Name,Url,LogoUrl,IsDisplay,AddTime from Links ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Tc.Model.Links model=new Tc.Model.Links();
		...
		/// 得到一个对象实体
		/// </summary>
		public Tc.Model.Links DataRowToModel(DataRow row)
		{
			Tc.Model.Links model=new Tc.Model.Links();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,Url,LogoUrl,IsDisplay,AddTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Name,Url,LogoUrl,IsDisplay,AddTime ");
			strSql.Append(" FROM Links ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
