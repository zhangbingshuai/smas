...
namespace Tc.DAL
{
	...
	public partial class Rights
	{
		...
		public bool Add(Tc.Model.Rights model)
		{
			...
			strSql.Append("ID,Name,Keys,Description,AddTime)");
			strSql.Append(" values (");
			strSql.Append("@ID,@Name,@Keys,@Description,@AddTime)");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.UniqueIdentifier,16),
					new SqlParameter("@Name", SqlDbType.NVarChar,100),
					new SqlParameter("@Keys", SqlDbType.NVarChar,500),
		...
		public Tc.Model.Rights GetModel(Guid ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Name,Keys,Description,AddTime from Rights ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = ID;

			Tc.Model.Rights model=new Tc.Model.Rights();
		...
		/// 得到一个对象实体
		/// </summary>
		public Tc.Model.Rights DataRowToModel(DataRow row)
		{
			Tc.Model.Rights model=new Tc.Model.Rights();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,Keys,Description,AddTime ");
