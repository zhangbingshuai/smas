...
namespace Tc.DAL
{
	...
	public partial class Config
	{
		...
		public int GetMaxId()
		{
		return DbHelper.GetMaxID("ID", "Config"); 
		}
		...
		public int Add(Tc.Model.Config model)
		{
			...
			strSql.Append("Ename,Name,Types,Content,AddTime)");
		...
		public Tc.Model.Config GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Ename,Name,Types,Content,AddTime from Config ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Tc.Model.Config model=new Tc.Model.Config();
		...
		/// 得到一个对象实体
		/// </summary>
		public Tc.Model.Config DataRowToModel(DataRow row)
		{
			Tc.Model.Config model=new Tc.Model.Config();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Ename,Name,Types,Content,AddTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Ename,Name,Types,Content,AddTime ");
			strSql.Append(" FROM Config ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
